    ...
    <AuthLayout title="Set a new password" subtitle="Choose something you'll remember">
      {done ? (
        <div className="space-y-4 text-center">
          <p className="text-sm text-ink-600 dark:text-ink-200">Your password has been updated.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {!token && <p className="rounded-lg bg-accent-50 px-3 py-2 text-sm text-accent-600 dark:bg-accent-500/15 dark:text-accent-400">Missing reset token. Use the link from your email.</p>}
          <div>
