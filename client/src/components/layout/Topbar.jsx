          ...
          {menuOpen && (
            <div className="absolute right-0 z-20 mt-2 w-48 card shadow-panel p-1.5">
              ...
              <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-2.5 py-1.5 text-left text-sm text-ink-600 hover:bg-ink-50 dark:text-ink-300 dark:hover:bg-ink-700"
              >
                <User className="h-3.5 w-3.5" /> Profile settings
              </button>
              <button
                onClick={logout}
                className="flex w-full items-center gap-2 rounded-md px-2.5 py-1.5 text-left text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-500/10"
              >
