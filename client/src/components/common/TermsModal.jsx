  ...
  return (
    <Modal open={open} onClose={onClose} title="Terms & Privacy Policy" width="max-w-lg">
      <div
        ...
        className="max-h-80 space-y-3 overflow-y-auto rounded-lg border border-ink-100 p-4 text-sm leading-relaxed text-ink-600 dark:border-ink-700 dark:text-ink-200"
      >
        <h3 className="font-semibold text-ink-800 dark:text-ink-100">Terms of Service</h3>
        <p>
        ...
        <h3 className="font-semibold text-ink-800 dark:text-ink-100">Privacy Policy</h3>
        <p>
